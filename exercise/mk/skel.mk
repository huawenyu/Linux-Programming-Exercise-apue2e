...
# Wilson for linux use
CPPFLAGS = -MD $(DIR_CPPFLAGS) $(DIR_INCLUDES) $(addprefix -I,$(INCLUDES))
...
LDFLAGS = $(addprefix -L,$(LIBDIRS)) $(LDFLAGS_$(@)) $(addprefix -L,$(LIBDIRS_$(@RD)))
...
# Change from LINK.cc to LINK.c
MAKECMD.$(SOEXT) = $(LINK.c) -fPIC -Wl,-soname -Wl,$(notdir $@) $(DEP_OBJS) $(DEP_ARCH) $(DEP_LIBS) $(LIBS_$(@)) $(LDLIBS) -shared -o $@
DEFAULT_MAKECMD = $(LINK.c) $(DEP_OBJS) $(DEP_ARCH) $(DEP_LIBS) $(LIBS_$(@)) $(LDLIBS) -o $@
